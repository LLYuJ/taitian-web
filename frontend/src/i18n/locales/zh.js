export default {
  ...
  home: {
    ...
    companyIntro: {
      ...
      description: '泰田集团股份有限公司成立于2000年，注册资金6088万元，现拥有员工1000余人，是一家集研发、生产与销售为一体的高新技术企业，也是"专精特新"小巨人企业。拥有精密机床/空气压缩机、压缩机主机、拧紧工具以及精密机械零件加工三大生产基地。公司始终坚信先进的装备是一流品质的保障，引进国外先进生产线，并配备3000多台CNC加工设备，全面部署MES+ERP系统，实现人机信息的高度一体化。'
    },
    stats: {
      foundedIn: '公司创立于',
    ...
    divisions: {
      ...
      tighteningTools: {
        name: '拧紧工具事业部',
        desc: '建筑面积达40000平方米，配备先进生产线与智能化制造体系，年产能覆盖100万台专业级气动工具、10万台工业级电动工具以及5万台集成电池传感器的智能定扭工具，以规模化、精益化生产实力，为全球客户提供稳定、高效的交付保障。',
        phone: '400-826-1128',
        email: "sales{'@'}chinataitian.com",
        address: '中国浙江省台州市椒江区东太和路98号'
      },
      compressorHost: {
        name: '压缩机主机事业部',
        desc: '建筑面积达38,000平方米，专注于压缩机主机的研发与精益制造。主机年产能超30万台，凭借持续的技术创新与严苛的品质管控，我们为各类压缩机整机提供高效、可靠的核心动力单元，致力于推动行业能效提升与可持续发展。',
        phone: '400-826-1128',
        email: "sales{'@'}chinataitian.com",
        address: '中国浙江省台州市路桥区黄琅工业园滨海路1号'
      },
      precisionCompressor: {
        name: '精密机床/压缩机事业部',
        desc: '建筑面积达120,000平方米，致力于以高效节能的空气压缩机与高精度机床为核心，为客户提供一体化解决方案。我们专注提升工业生产的效率、可靠性与可持续性，以创新技术助力客户实现持续增长，共创卓越价值。',
        phone: '400-826-1128',
        email: "sales{'@'}chinataitian.com",
        address: '中国浙江省台州市椒江区海韵路528号'
      }
    },
    research: {
      title: '创新研发',
  ...
  aboutPage: {
    ...
    companyInfo: '企业信息',
    companyDesc1: '泰田集团股份有限公司成立于2000年，注册资金6088万元，现拥有员工1000余人，是一家集研发、生产与销售为一体的高新技术企业，也是"专精特新"小巨人企业。',
    companyDesc2: '公司拥有精密机床/空气压缩机、压缩机主机、拧紧工具以及精密机械零件加工三大生产基地。',
    companyDesc3: '公司始终坚信先进的装备是一流品质的保障，引进国外先进生产线，并配备3000多台CNC加工设备，全面部署MES+ERP系统，实现人机信息的高度一体化，构建起泰田独有的"一人多机、人机物协同"的多环节制程管控新体系，形成了泰田"专、精、尖"的智造模式。',
    stats: {
      founded: '公司创立',
      foundedUnit: '年',
      capital: '注册资金',
  ...
  servicesPage: {
    ...
    preSales: {
      tabName: '售前资讯',
      title: '定制您的解决方案',
      desc: '从设备选型到系统配置，我们的技术团队为您提供全程技术支持',
      process: {
        step1: '提交需求',
        step2: '工程师对接',
        step3: '方案制定',
      ...
      faq: {
        q1: '你们的气动扳手优势在哪里？',
        a1: '泰田集团凭借二十余年的专业制造积淀，选用定制高强度材料，结合微米级（0.001mm）精密加工工艺，确保产品在极端测试下仍能保持超过12,000次的有效打击寿命，其领先的耐用性与可靠性已获得市场充分验证，持续占据75%的市场份额，为客户提供持久稳定的动力解决方案。如需了解具体型号的技术参数与应用案例，欢迎进一步咨询我们的销售团队以获取详细信息。',
        q2: '工频和变频压缩机，哪种更适合我？',
        a2: '在选择压缩机类型时，关键在于评估您的实际工况与长期运行经济性。通常，在37kW以上的中高功率应用场景中，我们更推荐采用变频压缩机，其优势在于通过软启动技术显著降低启动电流冲击，大幅延长电机与机械部件的使用寿命，减少设备维护与电力损耗成本。变频系统可根据实际用气需求动态调节输出，尤其在负荷波动较大的场合可实现显著节能。若您的用气模式相对平稳且间歇运行，工频机型可作为基础选择，但就长期可靠性与成本控制而言，变频方案在多数工业场景中具备更明确的技术与经济优势。',
        q3: '主机是自产的吗？能效怎么样？',
        a3: '是的，我司压缩机主机全部为自主研发与生产。这确保了从核心设计、材料选型到精密制造的全流程自主可控，也是我们实现卓越性能与可靠性的根本。',
        q4: '产品是否有相关的认证？能否提供检测报告？',
        a4: '是的，我司产品严格遵循国际质量标准与市场准入要求。包括气动扳手、电动扳手、黄油机在内的全系列产品均已完成CE认证。如需查询具体产品的认证证书或报告详情，欢迎进一步咨询我们的销售团队以获取详细信息。',
        q5: '是否提供产品外观颜色和品牌标识的定制服务？',
        a5: '是的，我们提供全面的产品外观颜色与品牌标识定制服务。在达到最小订单量（MOQ）的前提下，基础的颜色与标识定制可免费提供。对于特殊涂层、专属标识或小批量订单，我们支持付费定制方案，以确保满足您的特定需求。如需了解具体的定制范围、起订量及流程细节，欢迎进一步咨询我们的销售团队以获取详细信息。',
        q6: '产品的保修期是多久？',
        a6: '压缩机主机的保修政策为：标准4轴承单级主机保修期为2年，进阶8轴承单级主机保修期为5年，上下双级主机保修期为5年。关于其他产品的具体保修条款，欢迎进一步咨询我们的销售团队以获取详细信息。'
      }
    },
    afterSales: {
      tabName: '售后保障',
    ...
    documents: {
      tabName: '产品资料',
      title: '产品资料库',
      desc: '您可以从中获取产品宣传册、官方说明书、技术参数与图纸'
    }
  },
  ...
  contactPage: {
    ...
    subtitle: '期待与您的合作',
    heroTitle: '期待您的联系！',
    heroSubtitle: '任何合作咨询、意见反馈或创意灵感，都将在这里获得我们专注的回应。',
    companyName: '泰田集团',
    companyDesc: '我们专注于提供以高可靠性拧紧工具、高效节能空气压缩机及精密机床为核心的全面解决方案。我们致力于提升工业生产的效率、可靠性与可持续性，助力客户创造持续增长的卓越价值。',
    formTitle: '我们如何帮助您?',
    formSubtitle: '请在此处留下问题，我们将尽快与您联系。',
    contactInfo: '联系方式',
    hotline: '服务热线',
    email: '公司邮箱',
    address: '公司地址',
